...
import 'package:eurosom/ui/chatGPT/utils/common.dart';
...
class _ChatMessageWidgetState extends State<ChatMessageWidget> {
  ...
  void share(BuildContext context,
      {String? question, String? answer, RenderBox? box}) async {
    await Share.share(
      'Q: ${question.validate()}\nChatGPT: ${answer.validate()}',
      sharePositionOrigin:
          isIOS ? box!.localToGlobal(Offset.zero) & box.size : null,
    );
  }
  ...
  Widget speakIconWidget() {
    return Container(
      ...
      decoration: decoration(
          color: isSpeak ? Colors.white : Colors.white.withAlpha(40)),
      child: Image.asset(
        ic_speak,
        height: 14,
        width: 14,
  ...
  Widget shareIconWidget() {
    return Container(
      ...
      share(context,
          question: widget.data.question, answer: widget.answer, box: box);
    });
  }
      ...
      children: [
        Container(
          ...
          margin: EdgeInsets.only(
              top: 3.0, bottom: 3.0, right: 0, left: (500 * 0.10).toDouble()),
          ...
          child: SelectableText(
            widget.data.smartCompose.validate().isNotEmpty
                ? 'Q: ${widget.data.question.splitAfter('of ')}'
        ...
        if (widget.answer.isEmpty && widget.isLoading)
          Center(
              child:
                  SpinKitThreeBounce(color: t14_TextField_BgColor, size: 20)),
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SelectableText('Ans: ${widget.answer}',
                          style:
